...
export default class Container extends React.Component<ContainerProps, ContainerState> {
    ...
    constructor(props: ContainerProps) {
        ...
        u1.id = "1";
        u1.Address = "Ye Galiyan Ye chaubara Yha Aana Na Doabara Ab hum to bahe pardesi ke tera yha koin nhi";
        u1.Email = "nahibanamail@kahi.pe.bhi";
        u1.Name = "PapaNeNahiRakhaNaam"; u1.Landline = "GareebiBhotH"; u1.Mobile = "DostKaNumberDu"; u1.Website = "www.moogle.com";
    ...
    render() {
        return (
            <div id='container'>
                ...
                <Switch>
                    <Route path='/Add' render={(props) => <UserForm
                        {...props}
                    ...
                    <Route path='/Userinfo/:id' render={(props) => <UserInfo {...props} getContact={this.getContact.bind(this)} deleteContact={this.Delete.bind(this)} NextLink={this.Nextlink.bind(this)} />} />
                </Switch>
